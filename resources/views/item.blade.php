...
`
    ...
    function editItem(id) {
        console.log('Tombol Edit Ditekan dengan ID:', id); // Tambahkan ini untuk debugging
        $.get("{{ $url }}/" + id, function (res) { // Pastikan URL ini benar
            console.log('Response AJAX:', res); // Tambahkan ini untuk debugging
            if (res.status) {
                ...
                console.error('Gagal mengambil data:', res.message); // Tambahkan ini untuk debugging
            }
        }).fail(function(xhr, status, error) {
            console.error('Error AJAX:', error); // Tambahkan ini untuk debugging
        });
    }
